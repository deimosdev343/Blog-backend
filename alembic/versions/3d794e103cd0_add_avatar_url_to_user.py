...
Revision ID: 3d794e103cd0
Revises: bddbf93b0e00
Create Date: 2026-01-24 14:41:35.796941
...
revision: str = '3d794e103cd0'
down_revision: Union[str, Sequence[str], None] = 'bddbf93b0e00'
...
def downgrade() -> None:
    ...
    sa.Column('avater_url', mysql.VARCHAR(length=500), nullable=False),
